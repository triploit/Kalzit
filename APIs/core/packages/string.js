GLang.defaultRuntimeEnvironment.qdSet("str_starts_with", {value:GLang.arrayFun(function(env, args){
	return {value:(args[1].value).startsWith(args[0].value) ? 1 : 0};
})});
GLang.defaultRuntimeEnvironment.qdSet("str_ends_with", {value:GLang.arrayFun(function(env, args){
	return {value:(args[1].value).endsWith(args[0].value) ? 1 : 0};
})});
GLang.defaultRuntimeEnvironment.qdSet("str_split", {value:GLang.arrayFun(function(env, args){
...
GLang.defaultRuntimeEnvironment.qdSet("str_sub", {value:function(env, args){
