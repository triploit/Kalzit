...
*/
GLang.dr.qdSet("dom_parse", {value:GLang.arrayFunction(1, function(args){
...
* To work with the data, please take a look at the other functions defined in this file, like "domAttribute", "domInner" and "domInnerText"
*/
GLang.dr.qdSet("dom_parse_html", {value:GLang.arrayFunction(1, function(args){
...
*/
GLang.dr.qdSet("dom_tags", {value:GLang.arrayFunction(2, function(args){
...
*/
GLang.dr.qdSet("dom_attribute", {value:GLang.arrayFunction(2, function(args){
...
*/
GLang.dr.qdSet("dom_inner_text", {value:GLang.arrayFunction(1, function(args){
...
* Usage: domInner: dom.
*/
GLang.dr.qdSet("dom_inner", {value:GLang.arrayFunction(1, function(args){
...
*/
GLang.dr.qdSet("dom_tag_name", {value:GLang.arrayFunction(1, function(args){
