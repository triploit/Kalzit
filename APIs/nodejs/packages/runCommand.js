GLang.dr.qdSet("run_command", {value:function(args){
	return GLang.stringValue(require("child_process").execSync(args[0].value + "").toString("UTF8"));
}});
GLang.dr.qdSet("run_command_from_array", {value:function(args){
...
GLang.dr.qdSet("run_command_async", {value:function(args){
...
GLang.dr.qdSet("run_command_raw", {value:function(args){
	return {value:require("child_process").execSync(args[0].value + "")};
}});
GLang.dr.qdSet("run_command_async_raw", {value:function(args){
