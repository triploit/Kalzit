;(function(){
	...
	GLang.dr.qdSet("load_global_async", {value:GLang.arrayFunction(2, function(args){
	...
	GLang.dr.qdSet("load_global_raw", {value:GLang.arrayFunction(1, function(args){
		var result = kLoad.loadGlobalRaw(args[0].value);
		return result ? {value:result} : GLang.voidValue
	})});
	
	GLang.dr.qdSet("load_global_with_status", {value:GLang.arrayFunction(1, function(args){
