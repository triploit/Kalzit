;(function(){
	...
	```
	*/
	GLang.dr.qdSet("ui_twitch_channel_player", {value:function(args){
	...
	```
	*/
	GLang.dr.qdSet("ui_twitch_video_player", {value:function(args){
	...
	```
	*/
	GLang.dr.qdSet("ui_twitch_collection_player", {value:function(args){
