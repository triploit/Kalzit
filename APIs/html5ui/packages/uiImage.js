...
GLang.dr.qdSet("ui_show_image_url", {value:GLang.arrayFun(function(args){
...
GLang.dr.qdSet("ui_show_image_url_directly", {value:GLang.arrayFun(function(args){
	var callback = args.length >= 2 ? args[1] : GLang.voidValue;
...
GLang.dr.qdSet("get_image_width", {value:GLang.arrayFun(function(args){
	var image = args[0].value;
	return {value:image.naturalWidth};
}), display:DISPLAY_FUNCTION});
GLang.dr.qdSet("get_image_height", {value:GLang.arrayFun(function(args){
	var image = args[0].value;
	return {value:image.naturalHeight};
}), display:DISPLAY_FUNCTION});

GLang.dr.qdSet("scale_image_to_url", {value:GLang.arrayFun(function(args){
...
GLang.dr.qdSet("ui_image_button", {value:GLang.arrayFun(function(args){
