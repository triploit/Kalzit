...
GLang.dr.qdSet("ui_show_image_url", {value:GLang.arrayFunction(2, function(args){
...
GLang.dr.qdSet("ui_show_image_url_directly", {value:GLang.arrayFunction(2, function(args){
	var callback = args.length >= 2 ? args[1] : GLang.voidValue;
...
GLang.dr.qdSet("get_image_width", {value:GLang.arrayFunction(1, function(args){
	var image = args[0].value;
	return {value:image.naturalWidth};
}), display:DISPLAY_FUNCTION});
GLang.dr.qdSet("get_image_height", {value:GLang.arrayFunction(1, function(args){
	var image = args[0].value;
	return {value:image.naturalHeight};
}), display:DISPLAY_FUNCTION});

GLang.dr.qdSet("scale_image_to_url", {value:GLang.arrayFunction(2, function(args){
...
GLang.dr.qdSet("ui_image_button", {value:GLang.arrayFunction(2, function(args){
