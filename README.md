...
The current version of this project is `0.10.0`. If you are interested in the latest changes to the project, [take a look at the changelog](/docs/changelog/0.10.0.md).
